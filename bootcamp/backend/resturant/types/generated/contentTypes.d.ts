...
export interface ApiInvoiceDetailsInvoiceDetails
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::invoice-details.invoice-details'
    > &
      Schema.Attribute.Private;
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    invoices_details: Schema.Attribute.Relation<
      'oneToMany',
      'api::invoice-details.invoice-details'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    pos_user: Schema.Attribute.Relation<'manyToOne', 'api::pos-user.pos-user'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPosUserPosUser extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::invoice-details.invoice-details': ApiInvoiceDetailsInvoiceDetails;
      'api::invoice.invoice': ApiInvoiceInvoice;
      'api::pos-user.pos-user': ApiPosUserPosUser;
